...
```{r}
data <- readLines("VOSClim_GTS_jan_2001.txt")
...
data <- readLines("VOSClim_GTS_feb_2001.txt")
...
data <- readLines("VOSClim_GTS_mar_2001.txt")
...
data <- readLines("VOSClim_GTS_may_2001.txt")
...
data <- readLines("VOSClim_GTS_jun_2001.txt")
...
data <- readLines("VOSClim_GTS_jul_2001.txt")
...
data <- readLines("VOSClim_GTS_aug_2001.txt")
...
data <- readLines("VOSClim_GTS_sep_2001.txt")
...
data <- readLines("VOSClim_GTS_oct_2001.txt")
...
data <- readLines("VOSClim_GTS_nov_2001.txt")
...
data <- readLines("VOSClim_GTS_dec_2001.txt")
...
#??
#latitude.range <- subset(data.2001, LAT >= -614 & LAT <= 1865)
#longitude.range <- subset(data.2001, LON >= 108 & LON <= 136)

#2002

```{r}
data <- readLines("VOSClim_GTS_jan_2002.txt")
...
data <- readLines("VOSClim_GTS_feb_2002.txt")
...
data <- readLines("VOSClim_GTS_mar_2002.txt")
...
data <- readLines("VOSClim_GTS_apr_2002.txt")
...
data <- readLines("VOSClim_GTS_may_2002.txt")
...
data <- readLines("VOSClim_GTS_jun_2002.txt")
...
data <- readLines("VOSClim_GTS_jul_2002.txt")
...
data <- readLines("VOSClim_GTS_aug_2002.txt")
...
data <- readLines("VOSClim_GTS_sep_2002.txt")
...
data <- readLines("VOSClim_GTS_oct_2002.txt")
...
data <- readLines("VOSClim_GTS_nov_2002.txt")
...
data <- readLines("VOSClim_GTS_dec_2002.txt")
...
```{r}
data <- readLines("VOSClim_GTS_jan_2003.txt")
...
data <- readLines("VOSClim_GTS_feb_2003.txt")
...
data <- readLines("VOSClim_GTS_mar_2003.txt")
...
data <- readLines("VOSClim_GTS_apr_2003.txt")
...
data <- readLines("VOSClim_GTS_may_2003.txt")
...
data <- readLines("VOSClim_GTS_jun_2003.txt")
...
data <- readLines("VOSClim_GTS_jul_2003.txt")
...
data <- readLines("VOSClim_GTS_aug_2003.txt")
...
data <- readLines("VOSClim_GTS_sep_2003.txt")
...
data <- readLines("VOSClim_GTS_oct_2003.txt")
...
data <- readLines("VOSClim_GTS_nov_2003.txt")
...
data <- readLines("VOSClim_GTS_dec_2003.txt")
...
data <- readLines("VOSClim_GTS_jan_2004.txt")
...
data <- readLines("VOSClim_GTS_feb_2004.txt")
...
data <- readLines("VOSClim_GTS_mar_2004.txt")
...
data <- readLines("VOSClim_GTS_apr_2004.txt")
...
data <- readLines("VOSClim_GTS_may_2004.txt")
...
data <- readLines("VOSClim_GTS_jun_2004.txt")
...
data <- readLines("VOSClim_GTS_jul_2004.txt")
...
data <- readLines("VOSClim_GTS_aug_2004.txt")
...
data <- readLines("VOSClim_GTS_sep_2004.txt")
...
data <- readLines("VOSClim_GTS_oct_2004.txt")
...
data <- readLines("VOSClim_GTS_nov_2004.txt")
...
data <- readLines("VOSClim_GTS_dec_2004.txt")
